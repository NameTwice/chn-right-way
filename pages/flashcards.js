...
=======
var writer = HanziWriter.create('character-target-div', '三', {
    width: 100,
    height: 100,
    padding: 5
});
...
>>>>>>> 4caeafc4a9faa8b935775424e51f26220d752f1f
...
for (let i = 0; i < dataSet.length; i++) {
  ...
  first_char = dataSet[i][0];
  char_curr.push(first_char);
}

for (let i = 0; i < dataSet.length; i++) {
  let char_text;
  char_text = dataSet[i][2];
  char_word.push(char_text);
}

//console.log(char_curr.length);

/*for (let i = 0; i < char_curr.length; i++) {
  console.log(`This is the ${i} element of the array. The char is ${char_curr[i]}`)
}
*/
let i = 0;
if (char_curr != '') {
  let word = document.querySelector("#character-target-text-div");
  word.innerHTML = `${char_word[i]}`;
  word.style.fontWeight = 'bold';

  var writer = HanziWriter.create('character-target-div', char_curr[i], {
    width: 325,
    height: 325,
    padding: 10,
    showOutline: true,
  ...
  console.log(`Next char is: ${char_curr[i + 1]}`);
  ...
  document.getElementById('button3').addEventListener('click', function() {
    word.innerHTML = `${char_word[i + 1]}`;
    writer.setCharacter(char_curr[i + 1]);
    i = i + 1;
  });
